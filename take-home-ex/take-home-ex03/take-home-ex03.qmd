...
```{r}
pacman::p_load(sf, tidyverse, tmap, sfdep, onemapsgapi, httr, jsonlite, olsrr, ggpubr, GWmodel, dotenv, matrixStats)
```
...
We're done with gathering and creating our data! Now we can move onto our exploratory data analysis and building our prediction models

Sort Storey Data (Change to Ordinal Scale by categorizing them in continuous order) - refer to aishah one. rather than megan's for this.
