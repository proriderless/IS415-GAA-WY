...
Maybe can stick to adaptive. Pick one to use (fixed or adaptive)

Though it can be fixed as water point sources are likely fixed to certain areas... (ppl)
...
Computing KDE using a fixed bandwidth (REMOVE THIS ONE)
