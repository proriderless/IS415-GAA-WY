...
Now that we have completed our spatial data analysis, it's time we look at some of the areas where there are particularly high clusters of functioning and non-functioning water points and determine whether they are clustered or not.
...
### Using the G Function for Functioning Water Points
...
### Using the G Function for Non-Functioning Water Points
...
### Running on the entire Osun State by including the Functioning and Non-functioning Water Points:

#### Creating the PPP and Owin object
...
#### G-Function on Functioning Water Points
...
#### G-Function on Non-Functioning Water Points
...
### **Run the L-Function on Osun State:**
